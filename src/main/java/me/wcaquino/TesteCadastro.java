...
public class TesteCadastro {
	...
	public void deveRealizarCadastroComSucesso(){
		...
		dsl.clickarnoelemento("elementosForm:cadastrar");
	...
	public void deveValidarComidaVegetariana(){
		dsl.escreve("elementosForm:nome", "Nome qualquer");
		dsl.escreve("elementosForm:sobrenome", "Sobrenome qualquer");
		dsl.clickarnoelemento("elementosForm:sexo:1");
		dsl.clickarnoelemento("elementosForm:comidaFavorita:0");
		dsl.clickarnoelemento("elementosForm:comidaFavorita:3");
		dsl.clickarnoelemento("elementosForm:cadastrar");
